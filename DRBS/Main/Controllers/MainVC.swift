...
//    private let tabbar = CustomTabBarController()
    ...
    private lazy var button: UIButton = {
        ...
        button.setTitle("사이드 메뉴 열어", for: .normal)
    ...
    func configureUI() {
        ...
        self.sideMenuVC.sideVCDelegate = self
...
//        showViewController(viewController: UINavigationController.self, storyboardId: "MainVC")
    ...
    //MARK: - Actions
    @objc open func buttonDidTapped() {
